...
FEEDBACK_LOG_PATH = ROOT / "logs" / "feedback_log.jsonl"
OPENAI_ERROR_LOG_PATH = ROOT / "logs" / "openai_error.log"
...
use_openai_enhancement = st.checkbox(
    ...
    help="Requires OPENAI_API_KEY in your environment or Streamlit secrets.",
)
                ...
                try:
                    with st.spinner("Running OpenAI enhancement..."):
                        status_placeholder.info(
                            "Calling the configured OpenAI model to interpret fit and rewrite opportunities."
                        )
